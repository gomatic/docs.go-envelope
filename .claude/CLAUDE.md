# `docs.go-envelope` — public documentation repository

This is the **public** documentation site for [`gomatic/go-envelope`](https://github.com/gomatic/go-envelope), created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages.
...
- **Keep docs in sync with the source.** When [`gomatic/go-envelope`](https://github.com/gomatic/go-envelope)'s API changes, update [`content/`](../content/) to match.
